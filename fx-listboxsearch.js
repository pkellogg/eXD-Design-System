...
var txt = "";
txt += "<UL class='fxlistclass' style='list-style: none;position:relative;padding:0px;font-family:roboto;width:600px;border: 3px #4D148C solid;border-radius: 5px;'><li style='text-decoration: none;border:none;cursor:pointer;'><input type='search'     name='q'    style = 'height:50px;width:600px;background-color:white;border-bottom:1px #4D148C solid;border-top:none;border-left:none;border-right:none;padding-left:10px;font-size:18px;font-family:roboto;color:black;'></input><img src='magnify.png' id = 'searchX' style='position:absolute;right:0px;top: 0px;height:48px;'/></li>"
...
class fxlistboxsearch extends HTMLElement {
	...
	window.customElements.define('fx-listboxsearch', fxlistboxsearch);  //new standard
