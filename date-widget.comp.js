(function () {
    ...
    <div class="container">
        ...
        <div class="month" style="padding-bottom:10px;"></div> 
        <div class="day"></div>
		<div style="position:absolute;right:10px;bottom:0px;"><svg height="15" width=""50"><text x="40" y="15" fill="white" font-size="16px" font-weight="bold">Fed</text> <text x="65" y="15" fill="orange" font-size="16px" font-weight="bold">Ex</text></svg></div>
        </div>
        <div class="right">
