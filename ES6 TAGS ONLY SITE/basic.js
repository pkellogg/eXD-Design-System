...
<input type="radio" class="fxradiobuttonclass" id="fxradio" style=" -ms-transform: scale(2); /* IE 9 */
    ...
    transform: scale(2);">
<label for="fxradio" class="container"   style="font-size:22px;font-family:roboto;">me</label>	
</form> 
    ...
    `;
     ...
     class NewWidgets extends HTMLElement {
    ...
    customElements.define('fx-me', NewWidgets);
})();