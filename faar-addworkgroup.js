...
<p style="font-size:22px;font-weight:bold;">Add Workgroup</p>

<form action="/action_page.php">

Workgroup title<br />  
<input type="search" name="title" value="Here goes some text" style="height:40px;width:96%;border-radius:5px;font-size:14px;padding-left:20px;"><br><br />
...
<button style="height:30px;width:1 0px;border:solid 2px silver;border-radius:30px;background-color:white;">Jony Ronson   X</button>

<button style="height:30px;width:120px;border:solid 2px silver;border-radius:30px;background-color:white;">Amiya Burn   X</button>
...
class faaraddworkgroup extends HTMLElement {
...
window.onclick = function(event) {
  if (event.target == modal) {
	...
	window.customElements.define('faar-addworkgroup', faaraddworkgroup);  //new standard
